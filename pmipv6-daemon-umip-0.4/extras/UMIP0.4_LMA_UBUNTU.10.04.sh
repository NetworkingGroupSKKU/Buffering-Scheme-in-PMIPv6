...
# 2 LMA case
#ip -6 route add 2002:100:10:8::/64 via 2003:1::2 
#ip -6 route add 2002:100::/64 via 2003:1::2
...
pmip6d -c  /home/ws/pmip/pmipv6-daemon-umip-0.4/extras/example-lma.conf
