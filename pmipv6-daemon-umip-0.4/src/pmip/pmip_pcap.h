...
* AnhKhuong added s_bit for low latency
*/
private_pmip_pcap(void pmip_pcap_msg_handler_associate(struct in6_addr mn_iidP, int iifP, int flag);)
private_pmip_pcap(void pmip_pcap_msg_handler_associate_smartbuff(struct in6_addr mn_iidP, int iifP, char* mag_addr);)
...
* AnhKhuong added s_bit for low latency
*/
private_pmip_pcap(void pmip_pcap_msg_handler_deassociate(struct in6_addr mn_iidP, int iifP, int flag);)
private_pmip_pcap(void pmip_pcap_msg_handler_report(struct in6_addr mn_iidP, int iifP, char* nmag_addr);)
#endif
/** @}*/
