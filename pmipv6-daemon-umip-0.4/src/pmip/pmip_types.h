...
typedef struct ip6_mh_opt_src_mn_addr ip6_mh_opt_src_mn_addr_t;
...
typedef struct msg_info_t {
	...
	int 						flag;				// anhkhuong added 1: use sbit, 2 use fpmip, 3 use RSS notify, 4 detachment in SMARTBUFF 0: ignore
	struct in6_addr				mn_info_mag_addr;	// anhkhuong added for FPMIP & SMART
} msg_info_t;

#define SBIT_FLAG	1
#define FPMIP_FLAG 	2
#define RSS_FLAG				3
#define SMARTBUFF_FLAG 4
#endif
/*@}*/
