...
//Anh Khuong: add
protected_pmip_handler(struct mh_handler    pmip_lma_rot_handler;)
protected_pmip_handler(struct mh_handler    pmip_mag_roi_handler;)
protected_pmip_handler(struct mh_handler    pmip_mag_ros_handler;)
protected_pmip_handler(struct mh_handler    pmip_mag_rosa_handler;)
protected_pmip_handler(struct mh_handler    pmip_mag_etm_handler;)
protected_pmip_handler(struct mh_handler    pmip_mag_hi_handler;)
protected_pmip_handler(struct mh_handler    pmip_mag_ha_handler;)
//Anh Khuong: end
