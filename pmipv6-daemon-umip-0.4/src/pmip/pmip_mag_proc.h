...
protected_pmip_mag_proc(int mag_create_tunnel(struct in6_addr *mn2_addr, struct in6_addr *mag2_addr, int flag);)
protected_pmip_mag_proc(int mag_delete_tunnel();)
protected_pmip_mag_proc(int mag_setup_route_before_send_PBU(struct in6_addr *mn_addr);)
protected_pmip_mag_proc(int mag_cleanup_for_fpmip(struct in6_addr *mn_addr);)
#endif
/** @}*/
