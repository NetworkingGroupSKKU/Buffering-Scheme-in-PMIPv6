...
static const size_t _mh_len[] = {
	...
	/* Anh Khuong add for new functions */
	sizeof(struct ip6_mh_rot),
	sizeof(struct ip6_mh_roi),
	sizeof(struct ip6_mh_ros),
	sizeof(struct ip6_mh_rosa),
	sizeof(struct ip6_mh_hi),
	sizeof(struct ip6_mh_ha),
	sizeof(struct ip6_mh_etm)
